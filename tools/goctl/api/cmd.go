...
func init() {
	...
	gormCmdFlags.BoolVarP(&gogen.VarBoolErrorTranslate, "trans_err", "t")
	gormCmdFlags.BoolVarP(&gogen.VarBoolUseCasbin, "casbin", "c")
	gormCmdFlags.BoolVarP(&gogen.VarBoolUseI18n, "i18n", "i")
	gormCmdFlags.StringVarP(&gogen.VarStringModelName, "model", "m")
	gormCmdFlags.StringVarP(&gogen.VarStringRpcName, "rpc_name", "r")
	gormCmdFlags.StringVarP(&gogen.VarStringGrpcPbPackage, "grpc_package", "g")
	gormCmdFlags.BoolVarP(&gogen.VarBoolOverwrite, "overwrite", "w")
	gormCmdFlags.StringVarP(&gogen.VarStringDir, "dir", "d")
